...
# Set seed for reproducibility (different from Power BI seed 42)
random.seed(100)
...
def generate_dirty_bookings(customers_df, buses_df, routes_df, num_records=3000):
    ...
    single_trip_count = int(num_customers * 0.60)
    ...
    for d in range(total_days):
        ...
        for seat_num in booked_seats:
            ...
            if current_date.month in [5, 6]:
                ...
                fare *= 0.85 if current_date.month == 11 else 1.25
...
def main():
    ...
    bookings_df = generate_dirty_bookings(customers_df, buses_df, routes_df, num_records=3000)
